 ...
 */
public class FeetFragment extends Fragment {

    // Recycler View code
    private DatabaseReference feet_imagesRef;
    private RecyclerView feet_recyclerView;
    RecyclerView.LayoutManager feet_layoutManager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        feet_imagesRef = FirebaseDatabase.getInstance().getReference().child("feet");
        // to retrieve text in app offline
        feet_imagesRef.keepSynced(true);


        // Recycler View code
        feet_recyclerView = view.findViewById(R.id.mehndi_recycler_images);
        feet_recyclerView.setHasFixedSize(true);
        feet_layoutManager = new GridLayoutManager(getContext(), 3);
        feet_recyclerView.setLayoutManager(feet_layoutManager);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<MehndiImages> options =
                new FirebaseRecyclerOptions.Builder<MehndiImages>()
                        .setQuery(feet_imagesRef, MehndiImages.class)
                        .build();
        ...
        feet_recyclerView.setAdapter(adapter);
