...
public class PalmFragment extends Fragment {
    ...
    // Recycler View code
    private DatabaseReference palm_imagesRef;
    private RecyclerView palm_recyclerView;
    RecyclerView.LayoutManager palm_layoutManager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        palm_imagesRef = FirebaseDatabase.getInstance().getReference().child("palm");
        // to retrieve text in app offline
        palm_imagesRef.keepSynced(true);



        // Recycler View code
        palm_recyclerView = view.findViewById(R.id.mehndi_recycler_images);
        palm_recyclerView.setHasFixedSize(true);
        palm_layoutManager = new GridLayoutManager(getContext(), 3);
        palm_recyclerView.setLayoutManager(palm_layoutManager);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<MehndiImages> options =
                new FirebaseRecyclerOptions.Builder<MehndiImages>()
                        .setQuery(palm_imagesRef, MehndiImages.class)
                        .build();
        ...
        palm_recyclerView.setAdapter(adapter);
